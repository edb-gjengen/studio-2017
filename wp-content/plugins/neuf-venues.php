...
/*
  ...
  Description: Plugin to manage venues for STUDiO
  Version 0.1
  Author: Sjur Hernes
  ...
  class NeufVenues{
	...
	register_post_type(
			   ...
			   array(
				 'labels' => array(
						   'name'                  =>      __( 'Sted'                         ),
						   'singular_name'         =>      __( 'Steder'                       ),
						   'add_new'               =>      __( 'Legg til nytt sted'           ),
						   'add_new_item'          =>      __( 'Legg til nytt sted'           ),
						   'edit_item'             =>      __( 'Rediger sted'                 ),
						   'new_item'              =>      __( 'Legg til nytt sted'           ),
						   'view_item'             =>      __( 'Vis sted'                     ),
						   'search_items'          =>      __( 'Søk etter sted'               ),
						   'not_found'             =>      __( 'ingen steder funnet'          ),
						   'not_found_in_trash'    =>      __( 'ingen steder funnet i søppel' )
						   ),
				 'menu_position'       =>  7,
				 'public'              =>  true,
	...
	$html .= '        <td class="stedtype" style="font-size:smaller;">' . $type . '</td>';
	$html .= '    </tr>';
	endwhile;
